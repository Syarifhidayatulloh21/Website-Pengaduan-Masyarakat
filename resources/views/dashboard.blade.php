			...
			<div class="container-fluid p-0">
				...
				<div class="col-md-4">
					<div class="card mb-3 widget-chart">
						...
						<div class="widget-numbers"><span>{{$pengaduan}}</span></div>
					<div class="widget-subheading">Pengaduan</div>
					</div>
				</div>
					<div class="col-md-4">
						<div class="card mb-3 widget-chart">
							<div class="icon-wrapper rounded-circle">
								<div class="icon-wrapper-bg bg-danger"></div>
									<i class="ti-settings text-danger"></i></div>
										<div class="widget-numbers"><span>{{$tanggapan}}</span></div>
											<div class="widget-subheading">Tanggapan</div>
											</div>
										</div>
						<div class="col-md-4">
							<div class="card mb-3 widget-chart">
								<div class="icon-wrapper rounded-circle">
									...
									<div class="widget-numbers"><span>{{$pengguna}}</span></div>
									<div class="widget-subheading">Pengguna</div>
